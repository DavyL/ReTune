...
physics = dinv.physics.Blur(filter_rgb, padding="reflect", device=device, noise_model=dinv.physics.GaussianNoise(0.05))
#physics = dinv.physics.Blur(filter_rgb, padding="reflect", device=device, noise_model=dinv.physics.GaussianNoise())
