...
train_dataset = load_dataset(train_dataset_name, train_transform, measurement_dir, download=True)
test_dataset = load_dataset(test_dataset_name,   test_transform, measurement_dir, download=True)
